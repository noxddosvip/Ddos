...
TELEGRAM_BOT_TOKEN = '7510305221:AAEPLP6jzekNj3tvoTaqQ0wgm0a9Az8eEvg'
ADMIN_USER_ID = 5701803545
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "*🔥 Welcome to the Nox Vip Bot 🔥*\n\n"
        "*Use /attack <ip> <port> <duration>*\n"
        "*Lets Start Fucking Lobby...⚔️💥*"
    )
...
async def attack(update: Update, context: CallbackContext):
    ...
    if user_id not in users:
        await context.bot.send_message(chat_id=chat_id, text="*⚠️ Abe pehle buy kar @FlxSyco se.*", parse_mode='Markdown')
        return
